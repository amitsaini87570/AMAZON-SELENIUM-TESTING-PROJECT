...
public class TC_RF_003_Register_functionality2 extends basetestamzn {
	public static final String ACCOUNT_SID = "ACeeb223a28b90334a112f648e6f765a8f";
	public static final String AUTH_TOKEN = "[AuthToken]";

	@Test(priority = 3)
	public void providing_existing_account_details_tc_003() {
		Reporter.log("tc_0003_provide_existing_account");
...
//name
		driver.findElement(By.xpath(loc.getProperty("your_name"))).sendKeys((loc.getProperty("name3")));
...
//mobile
		driver.findElement(By.xpath(loc.getProperty("mobile_no1100011"))).sendKeys((loc.getProperty("mobile3")));
//password
		driver.findElement(By.xpath(loc.getProperty("password"))).sendKeys((loc.getProperty("password3")));
//verify mobile no	
