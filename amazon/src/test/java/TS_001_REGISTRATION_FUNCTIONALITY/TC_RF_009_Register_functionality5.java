...
public class TC_RF_009_Register_functionality5 extends basetestamzn {

	@Test(priority = 9)
	public void spaces_entered_trimmed_tc_rf_008() {
		Reporter.log("tc_0009_provide_trimmmed_entry_fields");
...
//name
		driver.findElement(By.xpath(loc.getProperty("your_name"))).sendKeys((loc.getProperty("name9")));
...
//mobile
		driver.findElement(By.xpath(loc.getProperty("mobile_no11"))).sendKeys((loc.getProperty("mobile9")));
//password
		driver.findElement(By.xpath(loc.getProperty("password"))).sendKeys((loc.getProperty("password9")));
//verify mobile no	
		driver.findElement(By.xpath(loc.getProperty("verify_mobile_no"))).click();
//field text are not trimmed
