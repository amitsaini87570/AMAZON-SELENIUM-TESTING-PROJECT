...
public class TC_MAI_009_MY_ACCOUNT_INFORMATION6 extends TC_LF_001_LOGIN_FUNCTIONALITY {
	@Test
	public void validate_support_environment() {
		...
		// 'my account information' functionality is working in all the supported
		// environments
