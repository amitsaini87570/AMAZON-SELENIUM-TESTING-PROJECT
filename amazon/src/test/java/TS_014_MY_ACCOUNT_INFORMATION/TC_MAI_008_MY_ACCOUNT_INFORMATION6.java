...
public class TC_MAI_008_MY_ACCOUNT_INFORMATION6 extends TC_LF_001_LOGIN_FUNCTIONALITY {
	@Test
	public void validate_ui() {
		...
		// Proper and good UI are displayed on the 'my account information' page
