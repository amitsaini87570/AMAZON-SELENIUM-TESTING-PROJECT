...
public class TC_PDP_011_PRODUCT_DISPLAY_PAGE8 extends TC_LF_001_LOGIN_FUNCTIONALITY {
@Test
...
//login to application
		TC_PDP_011_PRODUCT_DISPLAY_PAGE8 display_pdp_001 = new TC_PDP_011_PRODUCT_DISPLAY_PAGE8();
		...
		driver.findElement(By.xpath(loc.getProperty("click_on_product_imageTC_PDP_000011"))).click();
		...
		//Display page by using the Product Image
