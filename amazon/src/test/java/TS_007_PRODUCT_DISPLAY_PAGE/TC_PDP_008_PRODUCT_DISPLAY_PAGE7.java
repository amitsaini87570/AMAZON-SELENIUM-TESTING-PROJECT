...
public class TC_PDP_008_PRODUCT_DISPLAY_PAGE7 extends TC_LF_001_LOGIN_FUNCTIONALITY {
@Test
	public void validate_product_qty_zero_negative1() {
		JavascriptExecutor js = ((JavascriptExecutor) driver);

//login to application
		TC_PDP_008_PRODUCT_DISPLAY_PAGE7 display_pdp_001 = new TC_PDP_008_PRODUCT_DISPLAY_PAGE7();
		...
		driver.findElement(By.xpath(loc.getProperty("qty_edit_TC_PDP_008"))).click();

		//product qty has no option for edit
