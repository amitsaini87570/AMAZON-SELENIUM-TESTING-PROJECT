...
public class TC_FF_002_FORGOT_PASSWORD_FUNCTIONALITY extends basetestamzn {

	public static final String ACCOUNT_SID = "ACeeb223a28b90334a112f648e6f765a8f";
	public static final String AUTH_TOKEN = "[AuthToken]";

	@Test
	public void different_password_confirm_password() {
		...
		driver.findElement(By.xpath(loc.getProperty("password_againTC_FF_002")))
				.sendKeys((loc.getProperty("user_again_passwordTC_FF_002")));
