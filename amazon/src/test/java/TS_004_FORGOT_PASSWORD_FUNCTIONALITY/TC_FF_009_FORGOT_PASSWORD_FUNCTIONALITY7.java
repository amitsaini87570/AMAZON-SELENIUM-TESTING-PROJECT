...
public class TC_FF_009_FORGOT_PASSWORD_FUNCTIONALITY7 extends basetestamzn {
	
	public static final String ACCOUNT_SID = "ACeeb223a28b90334a112f648e6f765a8f";
	public static final String AUTH_TOKEN = "[AuthToken]";

	@Test
	public void provide_invalid_mobile_no() {
		...
		driver.findElement(By.xpath(loc.getProperty("clear_mobilenoff007"))).sendKeys((loc.getProperty("user_invalid_mobile_FF_009")));
