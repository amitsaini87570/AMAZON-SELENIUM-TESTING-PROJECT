...
public class TC_SC_012_SHOPPINGCART_FUNCTIONALITY6 extends TC_SC_001_SHOPPINGCART_FUNCTIONALITY {
	@Test
	public void Validate_ui() {

		TC_SC_012_SHOPPINGCART_FUNCTIONALITY6 atc_001 = new TC_SC_012_SHOPPINGCART_FUNCTIONALITY6();
		atc_001.success_message_to_shoppingCart();
		// Proper and good UI are displayed on the 'shopping cart' page
	}
}
