...
public class TC_005_CONTECT_US3 extends TC_LF_001_LOGIN_FUNCTIONALITY {
	@Test
	public void validate_support_env() {
		TC_005_CONTECT_US3 tc_001_cs = new TC_005_CONTECT_US3();
...
//click on contect us 
		...
		// 'Contact page' functionality is working in all the supported environments
